...
class UserOperationError(Auth0ManagerError):
    ...
    def __init__(self, message: str, user_id: str = None, operation: str = None, details: str = None):
...
class APIError(Auth0ManagerError):
    ...
    def __init__(self, message: str, status_code: int = None, endpoint: str = None, details: str = None):
