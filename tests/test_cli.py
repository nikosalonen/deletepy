...
class TestOperationHandler:
    ...
    def test_get_operation_display_name(self):
        ...
        assert handler._get_operation_display_name("revoke-grants-only") == "Revoking grants and sessions"
    ...
    def test_calculate_export_parameters(self):
        ...
        with patch('src.deletepy.utils.request_utils.get_optimal_batch_size') as mock_batch, \
             patch('src.deletepy.utils.request_utils.get_estimated_processing_time') as mock_time:
    ...
    @patch('src.deletepy.cli.commands.validate_auth0_user_id')
    @patch('src.deletepy.cli.commands.get_user_id_from_email')
    def test_resolve_user_identifier_email(self, mock_get_user_id, mock_validate):
    ...
    @patch('src.deletepy.cli.commands.validate_auth0_user_id')
    @patch('src.deletepy.cli.commands.get_user_id_from_email')
    def test_resolve_user_identifier_multiple_users(self, mock_get_user_id, mock_validate):
    ...
    @patch('src.deletepy.cli.commands.validate_auth0_user_id')
    def test_resolve_user_identifier_auth0_id(self, mock_validate):
        ...
        mock_validate.assert_called_once_with("auth0|123456")

    @patch('src.deletepy.cli.commands.validate_auth0_user_id')
    def test_resolve_user_identifier_invalid_id(self, mock_validate):
        ...
        assert result is None
        assert "invalid_id" in invalid_user_ids
    ...
    def test_execute_user_operation_block(self, mock_block):
        ...
        mock_block.assert_called_once_with("auth0|123", "test_token", "https://test.auth0.com")
    ...
    def test_execute_user_operation_delete(self, mock_delete):
        ...
        mock_delete.assert_called_once_with("auth0|123", "test_token", "https://test.auth0.com")

    @patch('src.deletepy.operations.user_ops.revoke_user_sessions')
    @patch('src.deletepy.operations.user_ops.revoke_user_grants')
    def test_execute_user_operation_revoke_grants(self, mock_revoke_grants, mock_revoke_sessions):
        ...
        mock_revoke_sessions.assert_called_once_with("auth0|123", "test_token", "https://test.auth0.com")
        mock_revoke_grants.assert_called_once_with("auth0|123", "test_token", "https://test.auth0.com")
...
class TestCLIIntegration:
    ...
    @patch('src.deletepy.core.config.check_env_file')
    @patch('src.deletepy.core.auth.doctor')
    ...
    def test_check_unblocked_integration(self, mock_check_unblocked, mock_get_base_url, mock_get_token):
